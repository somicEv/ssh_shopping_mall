...
<script type="text/javascript">
	function change(){
		...
		img.src="${pageContext.request.contextPath}/checkImgAction.action?"+new Date().getTime();
	}
							 ...
							 <tr>
								...
								<td>
									<span class="fieldSet">
										...
										<img id="checkImage" class="checkImage" src="${pageContext.request.contextPath}/checkImgAction.action" title="点击更换验证码" onclick="change()">
									</span>
