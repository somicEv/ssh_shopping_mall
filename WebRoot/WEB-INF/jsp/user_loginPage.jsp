					...
					<form id="loginForm"  method="post" novalidate="novalidate" action="${pageContext.request.contextPath}/user_login.action">
						<table>
							<tbody><tr>
								...
								<td>
									<s:actionerror />
									<input type="text" id="username" name="username" class="text" maxlength="20"><s:fielderror fieldName="username"/>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off"><s:fielderror fieldName="password"/>
								</td>
							</tr>
								<%-- <tr>
									<th>
